...
use Cline\Assert\ValidationError;
...
dataset('invalidChoicesProvider', fn (): array => [
    'empty values' => [[], ['tux'], ValidationError::ValueEmpty->value],
    'empty recodes in $values' => [['tux' => ''], ['tux'], ValidationError::ValueEmpty->value],
]);
...
dataset('providerInvalidBetween', fn (): array => [
    ...
    [Date::tomorrow(), Date::yesterday(), Date::today()],
]);
...
dataset('providerInvalidBetweenExclusive', fn (): array => [
    ...
    ['aaa', 'aaa', 'bbb'],
    ['bbb', 'aaa', 'bbb'],
    [Date::today(), Date::today(), Date::tomorrow()],
    [Date::tomorrow(), Date::today(), Date::tomorrow()],
]);
