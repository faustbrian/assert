...
describe('XOR Operator', function (): void {
    test('passes when exactly one group succeeds (first group)', function (): void {
        expect(
            fn (): Expectation => assertExpect('hello')
                ->xor()
                ->toBeString()
                ->xor()
                ->toBeInt()
    ...
    test('passes when exactly one group succeeds (second group)', function (): void {
        expect(
            fn (): Expectation => assertExpect(123)
                ->xor()
                ->toBeString()
                ->xor()
                ->toBeInt()
    ...
    test('passes when exactly one group succeeds (third group)', function (): void {
        expect(
            fn (): Expectation => assertExpect(null)
                ->xor()
                ->toBeString()
                ->xor()
                ->toBeInt()
    ...
    test('handles complex XOR chains', function (): void {
        expect(
            fn (): Expectation => assertExpect('test@example.com')
                ->xor()
                ->toBeInt()
                ->xor()
                ->toBeString()
    ...
    test('throws descriptive error when multiple groups pass', function (): void {
        try {
            ...
            expect($invalidArgumentException->getMessage())->toContain('expected exactly one group to pass');
            expect($invalidArgumentException->getMessage())->toContain('but 2 groups passed');
        }
    });
    ...
    test('throws descriptive error when no groups pass', function (): void {
        try {
            ...
            expect($invalidArgumentException->getMessage())->toContain('All XOR groups failed');
            expect($invalidArgumentException->getMessage())->toContain('expected exactly one to pass');
        }
    });
