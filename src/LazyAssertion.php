...
final class LazyAssertion
{
    ...
    /** @var class-string<LazyAssertionException> The class to use for exceptions */
    ...
    public function verifyNow(): bool
    {
        ...
        throw_if($this->errors, call_user_func($callable, $this->errors));
    ...
    {
        throw_if(Assert::class !== $className && !is_subclass_of($className, Assert::class), new LogicException($className.' is not (a subclass of) '.Assert::class));
    ...
    {
        throw_if(LazyAssertionException::class !== $className && !is_subclass_of($className, LazyAssertionException::class), new LogicException($className.' is not (a subclass of) '.LazyAssertionException::class));
