...
final class LazyAssertion
{
    ...
    {
        throw_if(LazyAssertionException::class !== $className && !is_subclass_of($className, LazyAssertionException::class), LogicException::class, $className.' is not (a subclass of) '.LazyAssertionException::class);
