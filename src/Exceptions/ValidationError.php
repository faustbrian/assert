...
/**
 * Enumeration of validation error codes for assertion failures.
 *
 * Provides a comprehensive set of typed error codes used throughout the assertion
 * library. Each code represents a specific validation failure type, enabling
 * consistent error identification and handling across the application.
 *
 * Error codes are organized by category:
 * - Type validation (10-24, 207-250)
 * - Value state (14-15, 25, 205)
 * - String validation (17-21, 27, 31, 37-38, 50, 229, 238)
 * - Numeric validation (30, 35-36, 210-213, 219-220, 235-236)
 * - Array/Collection validation (22, 26, 41, 44-47, 216, 226-234, 246)
 * - Object/Class validation (28-29, 105-106, 202, 204, 208, 224-225, 244)
 * - Comparison validation (32-34, 38-39, 42-43)
 * - File system validation (101-104)
 * - Format validation (40, 48-49, 201, 203, 206, 214, 218)
 * - System validation (217, 221-223, 245)
 *
